...
2. [Feliz.Bulma](https://zaid-ajaj.github.io/Feliz/#/UIFrameworks/Bulma): Feliz.Bulma is a Bulma wrapper for [Feliz](https://zaid-ajaj.github.io/Feliz/#/).
...
2. [Add Bulma to your project](#TODO:_INSERT_LINK) (as a stylesheet or the npm package)

3. Insert `open Fulma` at the top of your `.fs` files

4. Start using Fulma components in your code.
...
2. Insert `open Feliz.Bulma` at the top of any of your `.fs` files

3. Start using Feliz.Bulma components in your code
